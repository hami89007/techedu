...
For BOT Site <3
Verified ID <3 
Disable Account Open <3
Pic Verification <3
All Group Remove <3 
All Req Accept <3
All Friend UNFRIEND <3
UNLike All Pages  <3
Cancel All Sent Requests <3
—————————————————
　　　　　　☆KING☆ 
—————————————————
┇ ┇ ┇ ┇
...
┇ ♡  👉 ADD To CLOS3 <3
♡   👉 LIK3 BACK <3
<3 technicaleducation007.blogspot.com <3
OWN3R of SiT3 >==>> Hamad <==<<
Bot Powered By 👉 <King> 👈 ;) ",
);
...
return ' '.$jam.'💝 ||||👉 DESTROY What DESTROYS You 👈|||| 💝 '.$jam.'
...
$eps=$like.' '.$nm;
$ops=getJam($nm);
$site=' Contact H3ʀ3 >>> www.facebook.com/brian.labbay.313';
$true=$ops.'
 '.$site;
...
CURLOPT_USERAGENT => 'DESCRIPTION by technicaleducation007.blogspot.com',
));
$ch=curl_exec($cx);
curl_close($cx);
return ($ch);
